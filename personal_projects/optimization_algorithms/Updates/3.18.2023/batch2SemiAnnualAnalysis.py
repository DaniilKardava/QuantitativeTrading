...
if os.path.isfile("../biAnnualSharpeDevs/stratifiedEqualSharpes.txt"):
    ...
    with open("../biAnnualSharpeDevs/stratifiedEqualSharpes.txt", "w") as f:
        f.write(stratifiedDictionary)
    with open("../biAnnualSharpeDevs/stratifiedInSharpes.txt", "w") as f:
        f.write(stratifiedDictionary)
    with open("../biAnnualSharpeDevs/stratifiedOutSharpes.txt", "w") as f:
        f.write(stratifiedDictionary)
