...
def createData(tickers, dateRange, sampleType, portfolioSize):
    if sampleType == "eval":
        ticker_data = yfinance.download(
            ...
            end=datetime.datetime(dateRange + 2, 1, 1),
            group_by="ticker",
            actions=True,
        )
    elif sampleType:
...
with open("everyOtherYearDevs/inSharpes.txt", "r") as f:
    savedInSharpes = json.load(f)
with open("everyOtherYearDevs/outSharpes.txt", "r") as f:
    savedOutSharpes = json.load(f)
with open("everyOtherYearDevs/equalSharpes.txt", "r") as f:
...
with open("everyOtherYearDevs/inSharpes.txt", "w") as f:
    json.dump(globalInSample, f)

with open("everyOtherYearDevs/outSharpes.txt", "w") as f:
    json.dump(globalOutSample, f)

with open("everyOtherYearDevs/equalSharpes.txt", "w") as f:
